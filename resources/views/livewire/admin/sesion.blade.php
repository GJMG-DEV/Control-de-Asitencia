            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Agreegar Seccion</h5>
                        <button type="button" class="btn-close" wire:click="cerrarModal"></button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <label class="form-label" for="validationDefault02">Nombre de la Seccion <span
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary" wire:click="agregarSeccion">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
